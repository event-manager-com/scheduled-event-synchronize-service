...
import gregad.eventmanager.scheduledeventsynchronizeservice.api.ApiConstants;
import gregad.eventmanager.scheduledeventsynchronizeservice.security.dto.NamePassword;
import gregad.eventmanager.scheduledeventsynchronizeservice.security.dto.Token;
...
public class TokenHolderServiceImpl implements TokenHolderService {
    ...
    public void refreshToken() {
        ...
        token = restTemplate.postForObject(securityServiceUrl + ApiConstants.GENERATE, request, Token.class).getToken();
    }
